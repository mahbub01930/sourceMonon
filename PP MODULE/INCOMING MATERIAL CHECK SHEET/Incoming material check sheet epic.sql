...
Operational Fields: 
                    QMST_ID,QD.ID QSN_DTL_ID,AQTG.GROUP_NAME,AQTG.DISPLAY_ORDER, SL_NO, QUESTION, ANSWER_ARRAY, ARRAY_SEPARATOR, ANSWER_FIELD,ARRAY_ANSWER,QD.QUEST_GROUP_ID 
...
SELECT QMST_ID,QD.ID QSN_DTL_ID,AQTG.GROUP_NAME,AQTG.DISPLAY_ORDER, SL_NO, QUESTION, ANSWER_ARRAY, ARRAY_SEPARATOR, ANSWER_FIELD,ARRAY_ANSWER,QD.QUEST_GROUP_ID 
...
DECLARE
    ...
    vIMCS_MST CLOB := '{
                       "imcs_mst":[
                          {
                             "receive_date":"22-01-2023",
                             "receive_time":"22-01-2023 10:03:21 AM",
                             "lc_po_no":1010,
                             "mat_prod_id":6001,
                             "vehicle_no":null,
